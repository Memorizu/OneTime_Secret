...
router = APIRouter(prefix='/test_secret', tags=['test_secret'])
...
@router.post('/',
             ...
             description='create test_secret',
             status_code=201
             )
...
async def get_secret(secret_key: str, secret_service: SecretService = Depends(get_service)):
